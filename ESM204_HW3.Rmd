...
The marginal external cost per kWh of electricity is 1.96 cents.
...
(536,719.5)
0.019 * 536,719.5 = 10,734.39 cents

 **Environmental Cost = $10,734.4**
...
(for 0 - 158,642) P = 31.61 - 0.000052Q
...
Q = 494500
P = 0.0000192(485388.5)
P = 9.319

qtax

a) the new quantity of electricity produced and consumed with the tax will be approximately **485,388.5 kWh,**  which is ** kWh** less than the status quo. 

b) The new price of electricity with the tax will increase from 10 cent to **11.28 cents**. 

c) 
high CS before tax = (0.5)(415576)(21.61) = 4,490,298

high CS after tax = (0.5)()() = 

effect = (CS before tax) - (CS after tax)

effect = 

d) 
low CS before tax = (0.5)(415576)(21.61) = 4,490,298

low CS after tax = (0.5)()()

effect = (low CS before tax) - (low CS after tax)
